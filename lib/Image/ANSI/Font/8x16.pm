package Image::ANSI::Font::8x16;

use base qw( Image::ANSI::Font );

=head1 NAME

Image::ANSI::Font::8x16 - The default 8x16 font

=head1 SYNOPSIS

	$font = Image::ANSI::Font::8x16->new;
...
Creates a new Image::ANSI::Font::8x16 object.

=cut

sub new {
	my $class = shift;
	my $self  = $class->SUPER::new( $chars );
